...
#Fit the model
clf = MultinomialNB() #Works better with discrete features
#clf = BernoulliNB() #Performs slightly worse than Multinomial
#clf = GaussianNB() #Performs very poorly
clf.fit(train_x, train_y)

#Predict on test set
predictions_Naive_Bayes_prob = clf.predict_proba(test_x)
predictions_Naive_Bayes_prob = predictions_Naive_Bayes_prob[:,1]
predictions_Naive_Bayes_01 = clf.predict(test_x)
...
false_positive_rate, recall, thresholds = roc_curve(test_y, predictions_Naive_Bayes_prob)
...
cm = confusion_matrix(test_y, predictions_Naive_Bayes_01)
